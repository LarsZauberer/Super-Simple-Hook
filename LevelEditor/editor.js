function obstacleDraw(pos1, pos2, target) {
    ...
    if (found == false) {
        if (target) {
            ...
            mapData.targets.push({"x": tw/width*pos1.x, "y": th/height*pos1.y, "sx": tw/width*size.x, "sy": th/height*size.y});
        } else {
            obstacles.push(new DevObstacle(world, pos1.x, pos1.y, size.x, size.y));
            mapData.obstacles.push({"x": tw/width*pos1.x, "y": th/height*pos1.y, "sx": tw/width*size.x, "sy": th/height*size.y, "type": 0});
        }
    }
